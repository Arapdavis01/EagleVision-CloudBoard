    ...
    <div className="max-w-2xl">
      ...
      {downProjects.length === 0 ? (
        ...
        <div className="space-y-4">
          {downProjects.map(p => (
            <div key={p.project_id} className="glass border-l-4 border-red-500 p-5 flex items-center justify-between">
              <div>
              ...
              <span className="bg-red-500/20 text-red-400 px-4 py-1.5 rounded-full text-xs font-bold uppercase">Offline</span>
            </div>
          ))}
        </div>
      )}
