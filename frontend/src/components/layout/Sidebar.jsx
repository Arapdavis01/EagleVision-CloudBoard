  ...
  return (
    <aside className="hidden md:flex flex-col w-64 bg-gray-900 text-white p-4">
      <h1 className="text-xl font-bold mb-8 flex items-center gap-2">
        <span className="text-blue-400">🦅</span> EagleVision
      </h1>
      ...
      <button onClick={logout} className="flex items-center gap-2 p-2 text-sm hover:bg-red-700/50 rounded transition-colors">
